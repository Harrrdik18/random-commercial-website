                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-300">
                            Your one-stop shop for premium silver jewelry and accessories.
                        </p>
                    ...
                    <div>
                        ...
                        <form className="space-y-2">
                            <input
                                ...
                                className="w-full px-4 py-2 rounded-lg bg-green-800 text-white placeholder-gray-400 border border-green-700 focus:outline-none focus:border-green-500"
                            />
                            <button
                                type="submit"
